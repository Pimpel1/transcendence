    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('displayname', models.CharField(default='Anonymous', max_length=255, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('friends', models.ManyToManyField(blank=True, to='user_app.userprofile')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('wannabe_friends', models.ManyToManyField(blank=True, related_name='wannabe_requests', to='user_app.userprofile')),
            ],
        ),
    ]
